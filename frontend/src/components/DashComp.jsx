        ...
        <div className="flex flex-col p-2 dark:bg-slate-800 gap-4 w-full rounded-md shadow-md">
          <div className="flex justify-between">
            <div className="flex flex-row">
              ...
              <h3 className="text-gray-400 text-xl m-4 uppercase">
                Total Users
              </h3>
          ...
          <div className="flex  gap-2 text-lg ml-3">
      ...
      <div className="flex flex-row gap-4 py-3  min-w-full">
        ...
        <div className="flex flex-col w-1/2 shadow-md rounded-md dark:bg-gray-800">
          <div className="flex justify-between  p-3 text-sm font-semibold">
            <h1 className="text-center p-2 text-lg">Recent users</h1>
              ...
              users.map((user) => (
                <Table.Body key={user._id} className="divide-y">
                  <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <Table.Cell className="w-13 text-lg">
                      {user.userName}
                    </Table.Cell>
                    <Table.Cell className="w-13 text-lg">
                      {user.email}
        ...
        <div className="flex flex-col w-1/2 shadow-md rounded-md dark:bg-gray-800">
          <div className="flex justify-between  p-3 text-sm font-semibold">
            <h1 className="text-center p-2 text-lg">Recent Courses</h1>
                ...
                <Table.Body key={course._id} className="divide-y">
                  <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                    <Link to={`/mycourse/${course._id}`}>
                      <Table.Cell className="w-15 text-lg">
                        <img
                          src={course.photo}
                          width={"100px"}
                          alt={course.title}
