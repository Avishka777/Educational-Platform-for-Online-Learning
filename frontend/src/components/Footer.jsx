        ...
        <Footer container className="h-50 sm:h-50">
          <div className="w-full">
            <div className="grid w-full justify-between sm:flex sm:justify-between md:flex md:grid-cols-1">
              <div className="ml-10">
                <img src={logo} className="h-24 sm:h-24 ml-5 mb-2" alt="Company Logo" />
                <span className="self-center whitespace-nowrap text-xl font-semibold dark:text-white">Knowledge.Net</span>
              ...
              <div className="grid grid-cols-3 gap-0 sm:mt-4 sm:grid-cols-3 sm:gap-6 ">
                <div className='hidden lg:inline'>
                  ...
                  <Footer.LinkGroup col>
                    <Footer.Link href="#">IT21833816</Footer.Link>
                    <Footer.Link href="#">IT21834806</Footer.Link>
                    <Footer.Link href="#">IT21833366</Footer.Link>
                    <Footer.Link href="#">IT21835278</Footer.Link>
                  </Footer.LinkGroup>
                </div>
                <div className='hidden lg:inline'>
            ...
            <div className="w-full sm:flex sm:items-center sm:justify-between">
              <Footer.Copyright href="#" by="2024 Knowledge.Net . All Rights Reserved.™" />
              <p className="text-teal-600 text-sm">Designed & Developed By SLIIT Undergraduates</p>
            </div>
          </div>
        </Footer>
      );
