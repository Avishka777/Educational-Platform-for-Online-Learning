...
import { HiUser, HiLogout, HiOutlineUserGroup, HiChartBar, HiOutlineAcademicCap, HiBell } from 'react-icons/hi';
        ...
        <Sidebar.ItemGroup className='flex flex-col gap-1'>
          ...
          {currentUser.isAdmin && (
            <Link to='/dashboard?tab=payments'>
              <Sidebar.Item active={tab === 'payments'} icon={FaAmazonPay} as='div'>Payments</Sidebar.Item>
            </Link>
          )}
